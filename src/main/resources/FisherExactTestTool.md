# Usage
This tool performs Fisher's exact test on the input `Expression table` file. It outputs a `Expression score` file which consists of the significance of each tag.
